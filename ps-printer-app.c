...
static void   ps_printer_update_for_installable_options(
...
//
// 'ps_printer_update_for_installable_options() - Update printer's driver
//                                                data and driver IPP
...
static void
ps_printer_update_for_installable_options(
    pappl_printer_t *printer,           // I - Printer
